...
\begin{equation}
Pr_{\phi} \{ |f(\phi)- \langle f \rangle| \geq \epsilon \} \leq 2exp(-\frac{2C(d+1)\epsilon^2}{\eta^2})
\end{equation}
...
En esta parte se dará una demostración matemática explícita del principio general canónico usando el lema de Levy
Habiendo dado una cota para $\eta$ ahora se puede usar por completo el lema \ref{lemma de levy} para la función $f(\phi)=\norm{\rho_{S} -\Omega_{S}}_{1}$ recordando que se reemplazará $d$ en el lema por $d=2d_{R}-1$. sustituyendo en el teorema se tiene:
...
\begin{multline}
\langle Tr_{S} \rho_{S}^2 \rangle= Tr_{RR'} \Big( \Big( \frac{\mathbbm{1}_{RR'}}{d_{R}(d_{R}+1)} \Big) (F_{SS'} \otimes \mathbbm{1}_{EE'})  \Big) \\
+ Tr_{RR'} \Big( \Big( \frac{\mathbbm{1}_{RR'}}{d_{R}(d_{R}+1)} \Big) (\mathbbm{1}_{SS'} \otimes F_{EE'} )  \Big)\\ 
\leq Tr_{RR'} \Big( \Big( \frac{\mathbbm{1}_{R}}{d_{R}} \otimes  \frac{\mathbbm{1}_{R'}}{d_{R}}  \Big) (F_{SS'} \otimes \mathbbm{1}_{EE'})  \Big)\\
+ Tr_{RR'} \Big( \Big( \frac{\mathbbm{1}_{R}}{d_{R}} \otimes  \frac{\mathbbm{1}_{R'}}{d_{R}}  \Big) (\mathbbm{1}_{SS'} \otimes F_{EE'} )  \Big)
\end{multline}
